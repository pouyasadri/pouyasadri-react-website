...
const greeting = {
    ...
    subTitle: "Boost your business with expert web and mobile solutions. I specialize in creating powerful websites, mobile apps, and SEO strategies to help your brand stand out. Ready to achieve digital excellence?",
    resumeLink: "",
...
const socialMediaLinks = [/* Your Social Media Link */
    ...
    {
        id: '4s', name: "Instagram", link: "https://instagram.com/pouyasadri_dev", fontAwesomeIcon: "fa-instagram", // Reference https://fontawesome.com/icons/instagram?style=brands
        backgroundColor: "#f09433", // Reference https://simpleicons.org/?q=instagram
    },

    {
        id: '5s', name: "What'sApp", link: "https://wa.me/+33744140840", fontAwesomeIcon: "fa-whatsapp", // Reference https://fontawesome.com/icons/instagram?style=brands
        backgroundColor: "#25D366", // Reference https://simpleicons.org/?q=instagram
    },
    {
        id: '2s', name: "Email", link: "mailto:info@pouyasadri.com", fontAwesomeIcon: "fa-google", // Reference https://fontawesome.com/icons/google?style=brands
...
const aboutMePageData = {
    sections: [{
        ...
        },
        {
            ...
            description: "Fluency in English, Persian, French, and basic Spanish allows me to engage with clients and communities worldwide. Outside of coding, my life vibrates to the rhythms of music and the challenges of video games, reflecting my multifaceted personality and creative spirit."
        },
        {
            id: '5A',
            title: "Get in Touch",
            description: "Embark on a journey with me as we explore the possibilities of transforming your digital visions into reality. Visit www.pouyasadri.com to learn more about my projects, or connect with me on LinkedIn and GitHub for a deeper dive into my professional world."
        },
    ],
}
const skills = {
    data: [{
        ...
        skills: ["⚡ Struggling to get noticed online? As a freelance SEO expert, I help businesses like yours skyrocket traffic & sales with powerful strategies & data-driven results. Contact me today for a free consultation and let's dominate your competition!", "⚡ Frustrated by low website traffic? I'm a freelance SEO specialist who turns invisible websites into traffic magnets. Using cutting-edge tools & proven methods, I unlock your website's potential and bring you more leads & sales. Get a free consultation and see the difference!", "⚡ Dominate your online space! I'm a freelance SEO expert who helps businesses like yours achieve exceptional results through targeted strategies & data-driven insights. Get more traffic, leads, & sales with my personalized SEO approach. Schedule your free consultation today!",],
        softwareSkills: [{
        ...
        skills: ["⚡ Build stunning & powerful websites from scratch. As a freelance full-stack developer, I design captivating front-ends and secure back-ends for unbeatable user experiences and top search rankings. Let's create something magical!",
        ...
        skills: ["⚡ Unlock your business potential with a mobile app! As a freelance app developer, I build powerful apps that improve SEO, reach more users, and engage them on a deeper level. Let's unlock your digital future together!",
        ...
        fileName: "DesignImg",
        skills: ["⚡ Websites & apps need care! As your freelance maintenance expert, I keep your projects bug-free, secure, and performing at their best. Let your digital garden bloom with my help!",
...
const servicesPageData = {
    services: [{
        ...
        subtitle: "Embark on a journey with me where every line of code weaves together functionality and aesthetics, creating digital spaces where your business isn't just seen—it's felt. Together, we'll bring your vision to life with web solutions that resonate deeply with your audience, crafting a place where they truly belong.",
        imageUrl: "webdev.webp",
        altName: "Full Stack Web Development | Freelancer | Pouya Sadri",
    }, {
        title: "E-commerce Solutions",
        subtitle: "Imagine an online store that does more than sell—it connects. With custom e-commerce solutions, we create shopping experiences that turn first-time visitors into loyal customers, fostering a sense of community and belonging with every purchase.",
        imageUrl: "ecommercedev.webp",
        altName: "E-commerce Solutions | Freelancer | Pouya Sadri",
    }, {
        title: "Custom CRM Systems",
        subtitle: "In the heart of every business are the relationships it nurtures. Our tailored CRM systems are the bridges between you and your customers, designed to strengthen these connections, making every interaction feel personal and valued.",
        imageUrl: "crm.webp",
        altName: "Custom CRM Systems | Freelancer | Pouya Sadri",
    }, {
        title: "Cloud Computing Services",
        subtitle: "Step into a future where your digital dreams are boundless. Our cloud computing services offer scalable, secure environments for your web applications, ensuring they soar high and reach far, bringing your business closer to where it belongs—in the hearts and minds of your audience.",
        imageUrl: "cloud.webp",
...
const FaqPageData = {
    ...
    subtitle: "Find answers to common queries about custom software solutions, project timelines, and pricing. Dive into our FAQ section to learn how we can elevate your digital presence.",

    faqData: [{
        id: '1F',
        question: "1. What are the services you offer?",
        answer: "I specialize in full-stack web development, mobile app development, and SEO optimization. My services include creating custom websites, developing mobile applications for both Android and iOS, and implementing SEO strategies to enhance your online presence.",
    }, {
        id: '2F',
        question: "2. How do you charge for your services?",
        answer: "Pricing is project-based, considering the scope, complexity, and timeline. I offer a free initial consultation to understand your needs and provide a detailed quote. Contact me to discuss your project and get a personalized estimate.",
    }, {
        id: '3F',
        question: "3. How long does it take to complete a project?",
        answer: "Project timelines vary based on the project's complexity and requirements. A standard web development project can take anywhere from 4 to 12 weeks, while mobile app development might range from 3 to 6 months. I prioritize clear communication and deadlines to ensure your project is delivered on time.",
    }, {
        id: '4F',
        question: "4. Can you handle projects for clients outside of France?",
        answer: "Yes, I work with clients globally, offering my services to both local customers in France and international clients. My experience and proficiency in English, French, and other languages facilitate seamless communication across different regions.",
    }, {
        id: '5F',
        question: "5. What makes your services unique?",
        answer: "With over 6 years of experience in full-stack development and a strong background in SEO, I offer comprehensive digital solutions tailored to your business needs. My approach combines technical expertise with creative strategies to enhance your digital footprint and drive success.",
    }, {
        id: '6F',
        question: "6. Do you offer ongoing support and maintenance?",
        answer: "Yes, I provide ongoing support and maintenance services to ensure your website and mobile app perform optimally. This includes regular updates, security checks, and any necessary enhancements to improve functionality and user experience."
    }, {
        id: '7F',
        question: "7. How can we start a project together?",
        answer: "To initiate a project, simply contact me through my website's contact form or via email. We'll schedule a consultation to discuss your project in detail, define your goals, and outline the next steps."
    }
    ],
};
// Experience Page
...
const projectsHeader = {
    title: "Projects",
    description: "I build powerful web and mobile apps (Android & iOS) that bring your ideas to life. I use the latest technology tools to craft beautiful user interfaces and robust backends, ensuring a seamless experience across all devices. Whether you need a simple app or a complex solution, I have the skills and expertise to deliver exceptional results.",
